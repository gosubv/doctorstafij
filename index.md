    ...
    <div class="container">
        ...
        <div class="specialization-grid">
            <div class="spec-card">
                ...
                <p>Лечение гипотиреоза, АИТ, тиреотоксикоза и узловых изменений железы.</p>
            </div>
            <div class="spec-card">
                <span class="spec-icon">🤰</span>
                <h3>Беременность</h3>
                <p>Сопровождение эндокринного здоровья будущих мам на всех этапах.</p>
            </div>
            <div class="spec-card">
                <span class="spec-icon">⚖️</span>
                <h3>Метаболизм</h3>
                <p>Работа с инсулинорезистентностью, ожирением и дефицитными состояниями.</p>
            </div>
        </div>
    </div>
</section>
