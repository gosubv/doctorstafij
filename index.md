...
<section id="consultation-details" class="consultation-section">
    <div class="container">
        ...
        <div class="consultation-grid">
            ...
            <div class="consultation-card">
                ...
                <ul>
                    ...
                    <li><strong>Персонализированное питание:</strong> Подбор лечебного протокола (AIP, LCHF, FODMAP) или коррекция рациона под ваши цели.</li>
        ...
        <div class="consultation-notice">
            ...
            <p>Консультация эндокринолога — это лечение заболеваний эндокринной системы. Здесь проводится беседа, назначение лечения при жалобах.</p>
            ...
            <p>📌 Если вы хотите обсудить именно такие результаты анализов и получить комплексный план для организма в целом — пожалуйста, запишитесь на консультацию эндокринолога-нутрициолога.</p>
